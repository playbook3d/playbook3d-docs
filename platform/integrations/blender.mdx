...
description: "Playbook's Blender Plugin streams render passes (depth, beauty, mask, outline) from Blender into ComfyUI Workflows. "
---
...
<Steps>
  ...
  <Step title="Copy & Paste your API key">
    ...
    <Frame>
      ![API Key](../../images/BlenderPlugin/api_key.png)
    </Frame>
  </Step>
</Steps>
...
<Steps>
  ...
  <Step title="Clone the Blender template workflow.">
    ...
    <Frame height="200">
      ![Teams](../../images/BlenderPlugin/blender_template.png)
    </Frame>
  </Step>
  <Step title="Select your team and workflow.">
    ...
    <Frame>
      ![Teams](../../images/BlenderPlugin/teams.png)
    </Frame>
  </Step>
  <Step title="Configure render settings.">
    ...
    <Frame>
      ![Teams](../../images/BlenderPlugin/render_passes.png)
    </Frame>
  </Step>
  <Step title="Run workflow in the cloud.">
    ...
    <Frame>
      ![Teams](../../images/BlenderPlugin/side_by_side.png)
    </Frame>
  </Step>
  <Step title="Optional: Access local render passes.">
    <Note>
      Access locally saved passes at **/Users/** Your Username **/Library/Application Support/Blender/4.2/extensions/user_default/Playbook/renders**
    </Note>
    
    <Frame>
      ![Teams](../../images/BlenderPlugin/local_passes.png)
    </Frame>
  </Step>
</Steps>